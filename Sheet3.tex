...
\begin{document}
    ...
    \begin{align*}
  	...
  	\(3* 0,0025948628328493466 = 0,0077845884985480398 \approx 0,778458\% \)
		...
		Ausgangszustand: \\
		\begin{tikzpicture}
			\draw (2.5cm, 0cm) node[above=2pt, xshift=-1.1cm] {8} -- (0cm, 2.5cm) node[right=2.2cm, yshift=-1cm] {3} -- (4.5cm, 0cm) node[above=2pt, xshift=-1cm] {9} -- cycle;
			\draw (0cm, 0cm) node[below=4pt] {f} -- (0cm, 2.5cm) node[right=0.85cm, yshift=-1.5cm] {2} -- (2.5cm, 0cm) node[below] {d} -- cycle;
			\draw (0cm, 2.5cm) node[above=4pt] {a} -- (4cm, 2.5cm) node[above=4pt] {c} -- (4.5cm, 0cm) node[below=4pt] {e};
			\draw (0cm, 0cm) node[above=4pt] {a} -- (2.5cm, -2cm) node[below=4pt] {b} -- (4.5cm, 0cm) node[below=4pt] {e};
			\node at (-0.25, 1.25) {4};
			\node at (4.5, 1.25) {7};
			\node at (2, 2.85) {1};
			\node at (1.6, -1) {6};
		...
		\end{tikzpicture}
		\begin{tikzpicture}
			\draw (0cm,1cm) node[below=4pt, xshift=-0.1cm] {f} --  (2cm,3cm) node[above=4pt, xshift=-1.2cm] {\{a, d, c, d, e\}};
		...
		\end{tikzpicture}
		\begin{tikzpicture}
			\draw (0cm,0cm) node[below=4pt] {f} --  (0cm,2cm) node[above=4pt] {\{a, d, c, d, e\}};
		...
		\begin{tikzpicture}
			\draw (2.5cm, 0cm) node[above=2pt, xshift=-1.1cm] {8} -- (0cm, 2.5cm) node[right=2.2cm, yshift=-1cm] {3} -- (4cm, 0cm) node[above=2pt, xshift=-1cm] {9} -- cycle;
			\draw (0cm, 0cm) node[below=4pt] {\{f, b\}} -- (0cm, 2.5cm) node[right=0.85cm, yshift=-1.5cm] {2} -- (2.5cm, 0cm) node[below] {d} -- cycle;
			\draw (0cm, 2.5cm) node[above=4pt] {a} -- (4cm, 2.5cm) node[above=4pt] {c} -- (4cm, 0cm) node[below=4pt] {e};
		...
		\end{tikzpicture}
		\begin{tikzpicture}
			\draw (0cm, 0cm) node[below=4pt] {\{f, b\}} -- (0cm, 2.5cm) node[above=4pt] {a} -- (4cm, 2.5cm) node[above=4pt] {c} -- (4cm, 0cm) node[below=4pt] {\{d, e\}} -- (0, 0);
			\draw (0, 0) to[bend right] (4, 0) node[below=0.65cm, xshift=-1.9cm] {5};
		...
		\\
		\begin{tikzpicture}
			\draw (0cm, 0cm) node[below=4pt] {\{f, b\}} -- (0cm, 2.5cm) node[above=4pt] {\{a, d, e\}} -- (4cm, 2.5cm) node[above=4pt] {c};
		...
		\end{tikzpicture}
		\begin{tikzpicture}
			\draw (0cm, 0cm) node[below=4pt] {\{a, b, d, e, f\}} -- (4cm, 2.5cm) node[above=4pt] {c};
    ...
    3. Durchgang: Ausgewählte Knoten ${3, 4, 7, 5}$
