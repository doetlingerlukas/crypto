...
\begin{document}
  ...
  \section*{25)}
    ...
    \subsection*{b)}
      ...
      \underline{0} \underline{00000000...}\\
    ...
    \subsection*{c)}
      ...
      \underline{0} \underline{1} \underline{00} \underline{10010010010010...}\\
      
      $(0,0,0), (0,0,1), (2,1,0), (3,n-5,0)$\\
      
      Kompressionsrate: $\frac{4}{n} = \lim\limits_{n \rightarrow \infty}{0}$
